...
function ProcSearchObject($category,$subject,$class,$type,$name,$version,$tower,$assettype,
	...
	if (!$category && !$subject && !$class && !$type && !$name && !$version && !$tower && !$assettype &&
		...
		FormSearchObject($category,$subject,$class,$type,$name,$version,$tower,$assettype,
		$alias,$wricef,$alm,$desc,$usage,$techrules,$comment,$group,
		$created,$creator,$changed,$changer,$status);
		exit();
	}
...
function ProcCopyObject($category,$subject,$class,$type,$name,$n_name,$version,$tower,$assettype,$alm,
	...
	if ($n_name == "") {
		...
		FormCopyObject($category,$subject,$class,$type,$name,$n_name,$version,$tower,$assettype,$alm,
		$alias,$wricef,$desc,$usage,$techrules,$comment,$group,$created,$creator,
		$changed,$changer,$status,$eprow,$epnamex,$epvaluex);
		exit();
	}
...
// RJ Changes
  ...
  <?php  }
	...
	ProcCopyObject($category,$subject,$class,$type,$name,$n_name,$version,$tower,$assettype,$alm,
		$alias,$wricef,$desc,$usage,$techrules,$comment,$group,$created,$creator,
		$changed,$changer,$status,$eprow,$epnamex,$epvaluex);
	exit();
}
